        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-0 text-gray-100">
              Comprehensive technology solutions for your business challenges
            </p>
          </div>
        </div>
      </header>
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          <CallToAction
            ...
            description="Contact our team to discuss your specific technology needs and how we can help you achieve your business goals."
